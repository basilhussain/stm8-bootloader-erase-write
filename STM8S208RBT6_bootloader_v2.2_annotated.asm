...
Loaded hexfile STM8S208RBT6_bootloader.hex from 0x6000 to 0x67ff
...
0x610d:  b6 00          ld A, $00                                cycles=1                         CAN stuff...
...
=============================================================================
Transmit function? (UART/CAN) Takes byte to send in A?
...
0x6323:  ae 63 7b       ldw X, #$637b                            cycles=2                             initialise pointer

0x6326:  cd 60 8a       call $608a                               cycles=4                             call watchdog refresh
0x6329:  72 00 00 8e 0f btjt $8e, #0, $633d  (offset=15)         cycles=2-3                           test status bit 0 is set - using UART1?
0x632e:  72 02 00 8e 20 btjt $8e, #1, $6353  (offset=32)         cycles=2-3                           test status bit 1 is set - using CAN?
0x6333:  72 0b 52 40 ee btjf $5240, #5, $6326  (offset=-18)      cycles=2-3                           check UART3 status register RXNE flag
0x6338:  c6 52 41       ld A, $5241                              cycles=1                             load byte from UART3 data reg
0x633b:  20 3d          jra $637a  (offset=61)                   cycles=2

0x633d:  72 0b 52 30 e4 btjf $5230, #5, $6326  (offset=-28)      cycles=2-3                           check UART1 status register RXNE flag
0x6342:  c6 52 30       ld A, $5230                              cycles=1                             load UART1 status reg
...
0x6385:  20 9f          jra $6326  (offset=-97)                  cycles=2                             loop?

0x6387:  ce 54 2a       ldw X, $542a                             cycles=2                             CAN stuff...
...
0x6391:  b7 83          ld $83,A                                 cycles=1                             write received complement command data byte to $83
0x6393:  b8 82          xor A, $82                               cycles=1                             XOR with $82
0x6395:  a1 ff          cp A, #$ff                               cycles=1                             test equality to 0xff - does complement match command?
0x6397:  26 31          jrne $63ca  (offset=49)                  cycles=1-2                           jump if not equal

0x6399:  b6 82          ld A, $82                                cycles=1                             switch statement for command code received - depending on value of byte in $82
0x639b:  ae 64 1f       ldw X, #$641f                            cycles=2
0x639e:  a1 00          cp A, #$00                               cycles=1                             case 0x00 - GET command
0x63a0:  27 d8          jreq $637a  (offset=-40)                 cycles=1-2
0x63a2:  ae 64 63       ldw X, #$6463                            cycles=2
0x63a5:  a1 11          cp A, #$11                               cycles=1                             case 0x11 - READ command
0x63a7:  27 d1          jreq $637a  (offset=-47)                 cycles=1-2
0x63a9:  ae 65 86       ldw X, #$6586                            cycles=2
0x63ac:  a1 21          cp A, #$21                               cycles=1                             case 0x21 - GO command
0x63ae:  27 ca          jreq $637a  (offset=-54)                 cycles=1-2
0x63b0:  ae 65 b4       ldw X, #$65b4                            cycles=2
0x63b3:  a1 31          cp A, #$31                               cycles=1                             case 0x31 - WRITE command
0x63b5:  27 c3          jreq $637a  (offset=-61)                 cycles=1-2
0x63b7:  ae 64 ae       ldw X, #$64ae                            cycles=2
0x63ba:  a1 43          cp A, #$43                               cycles=1                             case 0x43 - ERASE command
0x63bc:  27 bc          jreq $637a  (offset=-68)                 cycles=1-2
0x63be:  72 03 00 8e 07 btjf $8e, #1, $63ca  (offset=7)          cycles=2-3                           test status bit 1 - using UART1?
0x63c3:  ae 63 da       ldw X, #$63da                            cycles=2                             
0x63c6:  a1 03          cp A, #$03                               cycles=1                             case 0x03 - SPEED command
0x63c8:  27 b0          jreq $637a  (offset=-80)                 cycles=1-2

0x63ca:  72 03 00 8e 03 btjf $8e, #1, $63d2  (offset=3)          cycles=2-3                           test status bit 1 - using UART1?
0x63cf:  cd 61 0d       call $610d                               cycles=4                             if not, do some CAN stuff

0x63d2:  a6 1f          ld A, #$1f                               cycles=1
0x63d4:  cd 61 22       call $6122                               cycles=4                             transmit NACK
...
0x641f:  72 1a 54 24    bset $5424, #5                           cycles=1                            CAN stuff
0x6423:  a6 79          ld A, #$79                               cycles=1
0x6425:  cd 61 22       call $6122                               cycles=4                            transmit ACK
0x6428:  a6 05          ld A, #$05                               cycles=1                            initialise num bytes to send as 5
0x642a:  72 03 00 8e 01 btjf $8e, #1, $6430  (offset=1)          cycles=2-3                          test status bit 1
0x642f:  4c             inc A                                    cycles=1                            increment num. bytes to 6

0x6430:  cd 61 22       call $6122                               cycles=4                            transmit num bytes being sent (5 or 6)
0x6433:  a6 22          ld A, #$22                               cycles=1
0x6435:  cd 61 22       call $6122                               cycles=4                            transmit bootloader version (0x22 - v2.2)
0x6438:  a6 00          ld A, #$00                               cycles=1                            transmit supported commands:
0x643a:  cd 61 22       call $6122                               cycles=4                            0x00 - GET
0x643d:  72 03 00 8e 05 btjf $8e, #1, $6447  (offset=5)          cycles=2-3                          test status bit 1
0x6442:  a6 03          ld A, #$03                               cycles=1
0x6444:  cd 61 22       call $6122                               cycles=4                            if set, 0x03 - SPEED

0x6447:  a6 11          ld A, #$11                               cycles=1
0x6449:  cd 61 22       call $6122                               cycles=4                            0x11 - READ
0x644c:  a6 21          ld A, #$21                               cycles=1
0x644e:  cd 61 22       call $6122                               cycles=4                            0x21 - GO
0x6451:  a6 31          ld A, #$31                               cycles=1
0x6453:  cd 61 22       call $6122                               cycles=4                            0x31 - WRITE
0x6456:  a6 43          ld A, #$43                               cycles=1
0x6458:  cd 61 22       call $6122                               cycles=4                            0x43 - ERASE
0x645b:  a6 79          ld A, #$79                               cycles=1
0x645d:  cd 61 22       call $6122                               cycles=4                            transmit ACK
...
0x65b4:  72 02 00 8e 0b btjt $8e, #1, $65c4  (offset=11)         cycles=2-3                          test status bit 1
0x65b9:  a6 79          ld A, #$79                               cycles=1
0x65bb:  cd 61 22       call $6122                               cycles=4                            transmit ACK
0x65be:  ae 66 a1       ldw X, #$66a1                            cycles=2                            set jump pointer
0x65c1:  cc 63 26       jp $6326                                 cycles=1                            receive more data bytes...?
...
0x65d5:  90 5f          clrw Y                                   cycles=1                            set data buffer pointer to zero
0x65d7:  b7 88          ld $88,A                                 cycles=1                            store received data byte to $88 - number of data bytes minus 1
0x65d9:  2b 02          jrmi $65dd  (offset=2)                   cycles=1-2                          is number > 127? if so, jump
0x65db:  20 1c          jra $65f9  (offset=28)                   cycles=2

0x65dd:  ae 65 e3       ldw X, #$65e3                            cycles=2                            set jump pointer
0x65e0:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x65e3:  90 9f          ld A, YL                                 cycles=1
0x65e5:  b1 88          cp A, $88                                cycles=1                            
0x65e7:  27 08          jreq $65f1  (offset=8)                   cycles=1-2                          is data buffer pointer equal to num data bytes-1?
0x65e9:  90 5c          incw Y                                   cycles=1                            increment data buffer pointer
0x65eb:  ae 65 e3       ldw X, #$65e3                            cycles=2                            set jump pointer
0x65ee:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x65f1:  ae 65 f7       ldw X, #$65f7                            cycles=2                            set jump pointer
0x65f4:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x65f7:  20 06          jra $65ff  (offset=6)                    cycles=2

0x65f9:  ae 66 02       ldw X, #$6602                            cycles=2                            set jump pointer
0x65fc:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x65ff:  cc 63 ca       jp $63ca                                 cycles=1

0x6602:  72 02 00 8e 0e btjt $8e, #1, $6615  (offset=14)         cycles=2-3                          is bit 1 of status byte set?
0x6607:  90 e7 00       ld ($00,Y),A                             cycles=1                            if not, write received data byte to buffer (at location given by pointer Y)
0x660a:  90 9f          ld A, YL                                 cycles=1
0x660c:  b1 88          cp A, $88                                cycles=1
0x660e:  27 34          jreq $6644  (offset=52)                  cycles=1-2                          is data buffer pointer equal to num data bytes-1?
0x6610:  90 5c          incw Y                                   cycles=1                            increment data buffer pointer
0x6612:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x6615:  c6 54 29       ld A, $5429                              cycles=1                            CAN stuff...
...
0x6644:  ae 66 4a       ldw X, #$664a                            cycles=2                            set jump pointer
0x6647:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x664a:  72 02 00 8e 04 btjt $8e, #1, $6653  (offset=4)          cycles=2-3                          is bit 1 of status byte set?
0x664f:  b7 89          ld $89,A                                 cycles=1                            write received data byte to $89 - data checksum?
0x6651:  20 09          jra $665c  (offset=9)                    cycles=2

0x6653:  c6 54 2e       ld A, $542e                              cycles=1                            CAN stuff...
0x6656:  b7 89          ld $89,A                                 cycles=1
0x6658:  72 1a 54 24    bset $5424, #5                           cycles=1

0x665c:  72 0b 00 8e 16 btjf $8e, #5, $6677  (offset=22)         cycles=2-3                          is bit 5 of status byte set?
0x6661:  b6 88          ld A, $88                                cycles=1
0x6663:  a1 7f          cp A, #$7f                               cycles=1                            is num data bytes > 127? (wtf? this CP is unnecessary, the LD already sets N flag)
0x6665:  2b 10          jrmi $6677  (offset=16)                  cycles=1-2                          if so, jump

WTF is this following section doing? Seems like it is checking whether we will be block programming the flash and setting a flag accordingly
(because $87 bit 6 controls whether we enable block programming in the RAM write routine), but I don't see how checking the low byte of the address helps accomplish that.

0x6667:  b6 87          ld A, $87                                cycles=1
0x6669:  27 06          jreq $6671  (offset=6)                   cycles=1-2                          is low byte of address to be written zero? (i.e. is it start of a block?)
0x666b:  a1 80          cp A, #$80                               cycles=1
0x666d:  27 02          jreq $6671  (offset=2)                   cycles=1-2                          or is it 0x80?
0x666f:  20 06          jra $6677  (offset=6)                    cycles=2

0x6671:  72 1c 00 8e    bset $8e, #6                             cycles=1                            set bit 6 of status byte (block programming flash?)
0x6675:  20 04          jra $667b  (offset=4)                    cycles=2

0x6677:  72 1d 00 8e    bres $8e, #6                             cycles=1                            clear bit 6 of status byte (not block programming?)

0x667b:  72 0b 00 8e 0a btjf $8e, #5, $668a  (offset=10)         cycles=2-3                          is status byte bit 5 set?
0x6680:  cd 01 80       call $180                                cycles=4                            if so, call RAM write function!
0x6683:  b6 9c          ld A, $9c                                cycles=1                            return value (i.e. error status) is in $9c
0x6685:  27 06          jreq $668d  (offset=6)                   cycles=1-2                          is it zero?
0x6687:  cc 63 ca       jp $63ca                                 cycles=1                            otherwise, error (NACK)?

0x668a:  cd 67 a7       call $67a7                               cycles=4                            call non-block writing function?

0x668d:  cd 67 ba       call $67ba                               cycles=4                            call checksum calc func?
0x6690:  72 0f 00 8e f2 btjf $8e, #7, $6687  (offset=-14)        cycles=2-3                          is bit 7 of status byte set (checksum ok)? if not, error (NACK)?
0x6695:  a6 79          ld A, #$79                               cycles=1
0x6697:  cd 61 22       call $6122                               cycles=4                            transmit ACK
0x669a:  72 1f 00 8e    bres $8e, #7                             cycles=1                            clear bit 7 of status byte
0x669e:  cc 63 23       jp $6323                                 cycles=1                            DONE! go back to command handler!

0x66a1:  b7 84          ld $84,A                                 cycles=1                            load received byte to $84 - padding byte of addr (ignored?)
0x66a3:  b7 8f          ld $8f,A                                 cycles=1                            and to $8f (also used for checksum calc)
0x66a5:  ae 66 ab       ldw X, #$66ab                            cycles=2                            set jump pointer
0x66a8:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x66ab:  b7 85          ld $85,A                                 cycles=1                            load received byte to $85 - extended byte of address
0x66ad:  b7 8a          ld $8a,A                                 cycles=1                            and to $8a
0x66af:  b8 8f          xor A, $8f                               cycles=1                            update address checksum
0x66b1:  b7 8f          ld $8f,A                                 cycles=1
0x66b3:  ae 66 b9       ldw X, #$66b9                            cycles=2                            set jump pointer
0x66b6:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x66b9:  b7 86          ld $86,A                                 cycles=1                            load received byte to $86 - high byte of address
0x66bb:  b7 8b          ld $8b,A                                 cycles=1                            and to $8b
0x66bd:  b8 8f          xor A, $8f                               cycles=1                            update address checksum
0x66bf:  b7 8f          ld $8f,A                                 cycles=1
0x66c1:  ae 66 c7       ldw X, #$66c7                            cycles=2                            set jump pointer
0x66c4:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x66c7:  b7 87          ld $87,A                                 cycles=1                            load received byte to $87 - low byte of address
0x66c9:  b7 8c          ld $8c,A                                 cycles=1                            and to $8c
0x66cb:  b8 8f          xor A, $8f                               cycles=1                            update address checksum
0x66cd:  b7 8f          ld $8f,A                                 cycles=1
0x66cf:  ae 66 d5       ldw X, #$66d5                            cycles=2                            set jump pointer
0x66d2:  cc 63 26       jp $6326                                 cycles=1                            receive another byte

0x66d5:  b7 89          ld $89,A                                 cycles=1                            load received checksum to $89
0x66d7:  b8 8f          xor A, $8f                               cycles=1                            check against calculated checksum in $8f (if same, XOR of them equals zero)
...
0x66fd:  c7 50 5b       ld $505b,A                               cycles=1                            reset FLASH_CR2 reg, to default (0x00)
0x6700:  43             cpl A                                    cycles=1
0x6701:  c7 50 5c       ld $505c,A                               cycles=1                            reset FLASH_NCR2 reg, to default (0xff)
0x6704:  b6 84          ld A, $84                                cycles=1
0x6706:  26 5b          jrne $6763  (offset=91)                  cycles=1-2                          check padding byte of addr is zero, jump if not
0x6708:  be 85          ldw X, $85                               cycles=2                            load extended and high bytes of address 
0x670a:  a3 02 80       cpw X, #$280                             cycles=2                            are they >= 0x0280?
0x670d:  24 54          jrnc $6763  (offset=84)                  cycles=1-2                          if so, addr invalid
0x670f:  b6 85          ld A, $85                                cycles=1                            load extended byte of address again
0x6711:  27 06          jreq $6719  (offset=6)                   cycles=1-2                          is it zero? (checking for medium density, i.e. 32K device?)
0x6713:  72 1a 00 8e    bset $8e, #5                             cycles=1                            if not, set status bit 5
0x6717:  20 56          jra $676f  (offset=86)                   cycles=2

0x6719:  be 86          ldw X, $86                               cycles=2                            load high and low bytes of address
0x671b:  a3 80 00       cpw X, #$8000                            cycles=2                            are > 0x8000? (writing to flash?)
0x671e:  25 06          jrc $6726  (offset=6)                    cycles=1-2                          (why > test, surely should be >= ?)
0x6720:  72 1a 00 8e    bset $8e, #5                             cycles=1                            if not, set status bit 5
0x6724:  20 49          jra $676f  (offset=73)                   cycles=2

0x6726:  a3 58 00       cpw X, #$5800                            cycles=2                            is >= 0x5800? (reserved area)
0x6729:  24 38          jrnc $6763  (offset=56)                  cycles=1-2                          if so, addr invalid
0x672b:  a3 50 00       cpw X, #$5000                            cycles=2                            is > 0x5000? (GPIO/peripheral registers)
0x672e:  25 06          jrc $6736  (offset=6)                    cycles=1-2                          if so, continue
0x6730:  72 1b 00 8e    bres $8e, #5                             cycles=1                            if not, clear status bit 5
0x6734:  20 39          jra $676f  (offset=57)                   cycles=2

0x6736:  a3 49 00       cpw X, #$4900                            cycles=2                            is >= 0x4900? (reserved area)
0x6739:  24 28          jrnc $6763  (offset=40)                  cycles=1-2                          if so, addr invalid
0x673b:  a3 48 00       cpw X, #$4800                            cycles=2                            is > 0x4800? (option bytes)
0x673e:  25 13          jrc $6753  (offset=19)                   cycles=1-2                          if so, continue
0x6740:  72 1a 00 8e    bset $8e, #5                             cycles=1                            if not, set status bit 5
0x6744:  35 01 00 98    mov $98, #$01                            cycles=1                            set $98 to 1 (flag to say we're writing option bytes?)
0x6748:  a6 80          ld A, #$80                               cycles=1
0x674a:  c7 50 5b       ld $505b,A                               cycles=1                            set OPT bit of FLASH_CR2 reg
0x674d:  43             cpl A                                    cycles=1
0x674e:  c7 50 5c       ld $505c,A                               cycles=1                            and NOPT bit of FLASH_NCR2 reg
0x6751:  20 1c          jra $676f  (offset=28)                   cycles=2

0x6753:  a3 48 00       cpw X, #$4800                            cycles=2                            is >= 0x4800? (option bytes)
0x6756:  24 0b          jrnc $6763  (offset=11)                  cycles=1-2                          if so, addr invalid (??? - wtf, we already checked for option byte area)
0x6758:  a3 40 00       cpw X, #$4000                            cycles=2                            is > 0x4000? (EEPROM)
0x675b:  25 09          jrc $6766  (offset=9)                    cycles=1-2                          if so, continue
0x675d:  72 1a 00 8e    bset $8e, #5                             cycles=1                            if not, set status bit 5
0x6761:  20 0c          jra $676f  (offset=12)                   cycles=2

0x6763:  cc 63 ca       jp $63ca                                 cycles=1                            invalid address (jump to send NACK)

0x6766:  a3 18 00       cpw X, #$1800                            cycles=2                            is >= 0x1800? (reserved area)
0x6769:  24 f8          jrnc $6763  (offset=-8)                  cycles=1-2                          if so, invalid addr
0x676b:  72 1b 00 8e    bres $8e, #5                             cycles=1                            clear status bit 5

0x676f:  a6 79          ld A, #$79                               cycles=1
0x6771:  cd 61 22       call $6122                               cycles=4                            transmit ACK (address is valid)
0x6774:  b6 82          ld A, $82                                cycles=1
0x6776:  a1 31          cp A, #$31                               cycles=1                            was bootloader command ($82) 0x31 (WRITE)?
0x6778:  27 07          jreq $6781  (offset=7)                   cycles=1-2
0x677a:  a1 11          cp A, #$11                               cycles=1                            or was it 0x11 (READ)?
...
0x678e:  90 5f          clrw Y                                   cycles=1                            set buffer pointer to zero
0x6790:  ae 66 02       ldw X, #$6602                            cycles=2                            set jump pointer
0x6793:  cc 63 26       jp $6326                                 cycles=1                            receive another byte
...
Some kind of routine to write bytes from data buffer to flash? For non-block mode programming?

0x67a7:  5f             clrw X                                   cycles=1

0x67a8:  cd 60 8a       call $608a                               cycles=4                            call watchdog refresh func
...
Function to calculate checksum of data just written?

0x67ba:  5f             clrw X                                   cycles=1
0x67bb:  b6 88          ld A, $88                                cycles=1
0x67bd:  b7 8f          ld $8f,A                                 cycles=1

0x67bf:  cd 60 8a       call $608a                               cycles=4                            call watchdog refresh func
